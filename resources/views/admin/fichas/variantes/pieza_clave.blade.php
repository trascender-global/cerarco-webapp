    ...
    <div class="row">
        <div class="col-xl-2 col-sm-3">
            <div class="nav flex-column nav-pills" id="info-pieza" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="pieza-clave-general-tab-{{ $pieza_clave }}" data-toggle="pill" href="#pieza-clave-general-{{ $pieza_clave }}" role="tab"
                            ...
                            <div class="shadow-none mb-0">
                                <div class="form-group row">
                                    @foreach(\App\Models\PiezaClaveCategorias::find(config('constants.pieza_clave_categorias.datos_generales'))->campos as $campo)
                                        @include('admin.fichas.variantes.pieza_clave.campos_dos_columnas' , ['campo'=>$campo, 'dato' => $piezas_clave_datos->where('posicion',$campo->id)->first() , 'pieza_clave' => $pieza ])
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="pieza-clave-general-{{ $pieza_clave }}" role="tabpanel"
                            ...
                            <div class="shadow-none mb-0">
                                @foreach(\App\Models\PiezaClaveCategorias::find(config('constants.pieza_clave_categorias.cronologia'))->campos as $campo)
                                    @include('admin.fichas.variantes.pieza_clave.campos' , ['campo'=>$campo, 'dato' => $piezas_clave_datos->where('posicion',$campo->id)->first() , 'pieza_clave' => $pieza ])
                                @endforeach
                            </div>
                        </div>
