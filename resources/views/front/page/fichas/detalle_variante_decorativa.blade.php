        ...
        <div class="headrow fondo-azul">
            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 whitetitle small">VARIANTE DECORATIVA</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">VARIANTE DE DECORATIVA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col">
                <ul class="nav nav-pills nav-fill mb-3 px-4 mx-auto" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item px-1">
                        <a class="nav-link btn btn-warning text-uppercase btn-block" id="pills-decoracion-tab" data-toggle="pill" href="#pills-decoracion" role="tab" aria-controls="pills-decoracion" aria-selected="true">
                            DECORACION
                        </a>
                    </li>
                    <li class="nav-item px-1">
                ...
                <div class="tab-content px-4 mb-3" id="pills-tabContent">
                    <div class="tab-pane fade show active pb-4 pl-4 pr-4" id="pills-data" role="tabpanel" aria-labelledby="pills-data-tab">
                        @foreach($detalle['Descripción'] ?? [] as $titulo => $campo)
