        ...
        <div class="headrow fondo-beige">
            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 whitetitle small">VARIANTE ARQUEOMÉTRICA</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">VARIANTE ARQUEOMÉTRICA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col">
                <ul class="nav nav-pills nav-fill mb-3 px-4 mx-auto" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item px-1">
                        <a class="nav-link btn btn-warning text-uppercase btn-block" id="pills-petrografia-tab" data-toggle="pill" href="#pills-petrografia" role="tab" aria-controls="pills-petrografia" aria-selected="true">
                            PETOGRAFÍA
                        </a>
                    </li>
                    <li class="nav-item px-1">
                        <a class="nav-link btn btn-warning text-uppercase btn-block" id="pills-rayos-x-tab" data-toggle="pill" href="#pills-rayos-x" role="tab" aria-controls="pills-rayos-x" aria-selected="true">
                            DIFRACCIÓN RAYOS X
                        </a>
                    </li>
                    <li class="nav-item px-1">
                ...
                <div class="tab-content px-4 mb-3" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade pl-4 pr-4" id="pills-petrografia" role="tabpanel" aria-labelledby="pills-petrografia-tab">
                        @foreach($detalle['Petrografía'] ?? [] as $titulo => $campo)
                            @if($loop->odd || $loop->first)
                                <div class="row">
                                    @endif
                                    <div class="col-md-6">
                    ...
                    <div class="tab-pane fade pl-4 pr-4" id="pills-rayos-x" role="tabpanel" aria-labelledby="pills-rayos-x-tab">
                        @foreach($detalle['Difracción de rayos X'] ?? [] as $titulo => $campo)
                            @if($loop->odd || $loop->first)
                                <div class="row">
                                    @endif
                                    <div class="col-md-6">
