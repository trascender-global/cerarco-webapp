...
@section('content')
    ...
    <div class="checkout-main-area section-space--ptb_90 bg-beigelight">
                                ...
                                @foreach($fotos as $foto)
                                    <div class="col-xs-12 col-sm-6 col-md-6 nopad text-center">
                                        <label class="image-checkbox">
                                            <a href="{{ route('front.ficha.detalle_arqueometrica', ['modelo'=>$modelo, 'codigo' => $foto->codigo !== '' ? $foto->codigo : '-' ]) }}">
