<div class="card" style="box-shadow: none">
    ...
    <p>
        <span class="pieza-clave-description-title">{{ $campo->campo }}:</span>
        @php
            $valor=$piezas_clave_datos->where('posicion', $campo->id)->first();
        @endphp
        <span
            class="pieza-clave-description">@if($valor){{ $valor->valor }}@endif</span>
    </p>
    @endforeach
</div>
<div class="card" style="box-shadow: none">
        ...
        <div class="d-block">
            <div class="col-xl-2 col-sm-3">
                <div class="nav flex-column nav-pills" id="info-pieza" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="fotografias-general-tab-{{ $pieza_clave }}" data-toggle="pill"
                        href="#fotografias-general-{{ $pieza_clave }}" role="tab"
                        aria-controls="fotografias-general-{{ $pieza_clave }}" aria-selected="false">
                        <p class="font-weight-bold mt-1 mb-1">Fotografías</p>
                    </a>
                    <a class="nav-link" id="dibujos-general-tab-{{ $pieza_clave }}" data-toggle="pill"
                        href="#dibujos-general-{{ $pieza_clave }}" role="tab"
                        aria-controls="dibujos-general-{{ $pieza_clave }}" aria-selected="false">
                        <p class="font-weight-bold mt-1 mb-1">Dibujos</p>
                    </a>
                    <a class="nav-link" id="mapa-general-tab-{{ $pieza_clave }}" data-toggle="pill"
                        href="#mapa-general-{{ $pieza_clave }}" role="tab"
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="info-pieza-content">
                            ...
                            <div class="tab-pane fade" id="fragmento-general-{{ $pieza_clave }}" role="tabpanel"
                                ...
                                <div class="shadow-none mb-0">
                                    @foreach (\App\Models\PiezaClaveCategorias::find(config('constants.pieza_clave_categorias.fragmento'))->campos as $campo)
                                        @include('front.fichas.variantes.pieza_clave.campos', [
                                            'campo' => $campo,
                                            'dato' => $piezas_clave_datos->where('posicion', $campo->id)->first(),
                                            'pieza_clave' => $pieza,
                                        ])
                            ...
                            <div class="tab-pane fade" id="pieza-clave-decoracion-{{ $pieza_clave }}"
                                role="tabpanel" aria-labelledby="pieza-clave-decoracion-tab-{{ $pieza_clave }}">
                                <div class="shadow-none mb-0">
                                    <div class="form-group row">
                                        @foreach (\App\Models\PiezaClaveCategorias::find(config('constants.pieza_clave_categorias.decoracion'))->campos as $campo)
                                            @include('front.fichas.variantes.pieza_clave.campos_dos_columnas',
                            ...
                            <div class="tab-pane fade" id="difraccion-rayos-x-general-{{ $pieza_clave }}"
                                role="tabpanel" aria-labelledby=d"ifraccion-rayos-x-general-tab">
                                <div class="shadow-none mb-0">
                                    @foreach (\App\Models\PiezaClaveCategorias::find(config('constants.pieza_clave_categorias.difracion_rayos_x'))->campos as $campo)
                                        @include('front.fichas.variantes.pieza_clave.campos', [
                                            'campo' => $campo,
                            ...
                            <div class="tab-pane fade" id="dibujos-general-{{ $pieza_clave }}" role="tabpanel"
                                ...
                                <div class="shadow-none mb-0">
                                    @include('front.fichas.variantes.pieza_clave.dibujos', [
                                        'pieza_clave' => $pieza,
                                    ])
                                </div>
                            </div>
